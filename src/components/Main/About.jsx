        ...
        <div className="row container">
            <div className="columns" data-aos="fade-right" data-aos-delay="300">
                ...
                <h4>
                    <FormattedMessage
                        id='description'
                        defaultMessage='My name is Hasan Chowdhury and I am a full stack developer.'
                    />
                </h4>
                <p>
                    <FormattedMessage
                    ...
                    <li>
                        <p>
                            <span>
                                ...
                                Cycling, Photography and Programming
                        </p>
                    </li>
                    <li>
                        <p><span>Email:</span> chowdhuryh999@gmail.com</p>
                    </li>
                    <li>
                        <p>
                            <span>
